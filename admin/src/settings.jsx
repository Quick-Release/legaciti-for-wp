...
function SettingsApp() {
  ...
  return (
    <div style={{ padding: '20px 0' }}>
      {saveNotice && (
        <Notice status={saveNotice.status} isDismissible onRemove={() => setSaveNotice(null)}>
          {saveNotice.message}
        </Notice>
      )}
      ...
      <Card>
        ...
        <CardBody>
          ...
          <p style={{ color: '#757575', marginTop: '-10px', fontSize: '13px' }}>
            People profile URLs. Empty = <code>/asoares</code>, set prefix <code>people</code> for{' '}
      ...
      <Card style={{ marginTop: '30px' }}>
        ...
        <CardBody>
          <Flex align="center" gap={3}>
            ...
            <FlexItem>
              {settings.last_sync && (
                <span style={{ color: '#757575' }}>Last sync: {settings.last_sync}</span>
              )}
            </FlexItem>
          </Flex>
